...
@section('content')
    ...
    <div class="mb-6 flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
        ...
        <a href="{{ route('petugas.laporan.cetak', request()->query()) }}" class="rounded-lg bg-gray-900 px-4 py-2.5 text-center text-sm font-semibold text-white hover:bg-gray-700">Cetak laporan</a>
    </div>
