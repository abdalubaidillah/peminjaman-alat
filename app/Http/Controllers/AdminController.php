...
class AdminController extends Controller
{
        ...
        $alats = Alat::with('kategori')
            ->when($search, function ($query, $search) {
                return $query->where('nama_alat', 'like', "%{$search}%")
                    ->orWhere('satuan_kondisi', 'like', "%{$search}%")
    ...
    public function updateUserPhoto(Request $request, $id)
    {
        ...
        $user->update(['foto_profile' => 'storage/profile/' . $filename]);
    ...
    public function updateStatusPeminjaman(Request $request, $id)
    {
        ...
        try {
            ...
            if ($statusBaru == 'selesai' && !$peminjaman->pengembalian()->exists()) {
                Pengembalian::create([
                    'peminjaman_id' => $peminjaman->id,
                    'tgl_kembali' => now(),
    ...
    // Menampilkan peminjaman yang masih menunggu pengembalian
    public function indexMenungguPengembalian(Request $request)
    {
        ...
        return view('admin.pengembalian.menunggu', compact('peminjamans', 'search'));
    }
    ...
    public function updatePengembalian(Request $request, $id)
    {
        ...
        $pengembalian->update($request->only(['kondisi_kembali', 'denda']));
